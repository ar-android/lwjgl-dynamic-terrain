...
/**
 * Water renderer sets up the shaders, manages the water animation
 * @author smid
 *
 */
public class WaterRenderer {

    private static String DUDV_MAP = "dudvTile";
    private static String NORMAL_MAP = "waterNormalMap";
    ...
    public void render(List<WaterTile> water, Camera camera, Light sun) {
        ...
        for (WaterTile tile : water) {
            Matrix4f modelMatrix = utils.Maths.createTransformationMatrix(
